// DO NOT EDIT.
// code generated by goenums v0.4.3 at Aug  3 11:19:00.
//
...
var unitsNameMap = map[string]Unit{
	"unknownUnits": Units.UNKNOWNUNITS,
...
// unitsNames is a constant string slice containing all enum values cononical absolute names
const unitsNames = "unknownUnitsstandardmetricimperial"

// unitsNamesMap is a map of enum values to their canonical absolute
// name positions within the unitsNames string slice
var unitsNamesMap = map[Unit]string{
	Units.UNKNOWNUNITS: unitsNames[0:12],
	Units.STANDARD:     unitsNames[12:20],
	Units.METRIC:       unitsNames[20:26],
	Units.IMPERIAL:     unitsNames[26:34],
}

// String implements the Stringer interface.
// It returns the canonical absolute name of the enum value.
func (u Unit) String() string {
	if str, ok := unitsNamesMap[u]; ok {
		return str
	}
	return fmt.Sprintf("units(%d)", u.units)
}
